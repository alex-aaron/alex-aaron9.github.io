...
var panda = {
  species: 'panda',
  name: 'Gerome',
  noises: ['munch', 'crunch', 'sneeze', 'snore']
}
animals.push(panda);
var dog = {
  species: 'dog',
  name: 'Chloe',
  noises: ['bark', 'huff', 'sneeze', 'snore']
}
animals.push(dog)
...
//////////////////////////////////////////////////////////////////////
var friends = []; //easiest to create a list in my opinion
function getRandom(animals){
  //animals array
  //returns random index of array using Math.random
   var ind = Math.floor(Math.random() * animals.length);
   //returns random index of animals array
   return ind;
}
var random = animals[getRandom(animals)];
animals.friends = random.name;
console.log(friends)
